...
<body class="hold-transition sidebar-mini layout-fixed" style="font-family: 'Nuanta-Regular'">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        <img src="{{ asset('logo\noimage.png') }}" style="width: 30px; height: 30px" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    </a>
                </li>
        ...
        <footer class="main-footer">
            <strong>ບໍລິສັດ ນໍ້າດື່ມ ບໍລິການ&copy;2024.</strong>
            <div class="float-right d-none d-sm-inline-block">
                <b>Version: </b> 11.0.0.1
            </div>
        </footer>
    </div>
